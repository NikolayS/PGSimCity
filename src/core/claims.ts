  ...
  restoreDrill: {
    levels: {
      table: {
        ...
        supports: 'The modeled full-cluster backup fetch and archived-WAL replay reached the selected target, and the accounts smoke check found its expected row witness.',
      ...
      cluster: {
        ...
        supports: 'The modeled full-cluster backup fetch and archived-WAL replay reached the selected target, and every modeled table returned its expected smoke-check row witness.',
      ...
      verified: {
        ...
        supports: 'The modeled full-cluster backup fetch and archived-WAL replay reached the selected target, the restored-object digest matched its manifest, and every modeled table returned its expected smoke-check row witness.',
