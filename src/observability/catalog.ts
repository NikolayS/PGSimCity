...
export const CATALOG: CatalogEntry[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      'source', 'min_val', 'max_val', 'boot_val', 'reset_val', 'pending_restart',
    ],
  ...
  },
  {
    ...
    columns: [
      ...
      'shared_blk_read_time', 'shared_blk_write_time', 'wal_records', 'wal_fpi',
      'wal_bytes', 'wal_buffers_full', 'stats_since', 'minmax_stats_since',
    ],
